...
traces_dataid: {{ trace_data_id | default(-1) }}
metrics_dataid: {{ metric_data_id | default(-1) }}
logs_dataid: {{ log_data_id | default(-1) }}
profiles_dataid: {{ profile_data_id | default(-1) }}
