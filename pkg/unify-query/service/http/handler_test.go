...
func TestPromQLQueryHandler(t *testing.T) {
	...
	mock.BkSQL.Set(map[string]any{
		"SHOW CREATE TABLE `2_DSMonitorGamePlayInfo`": `{"result":true,"message":"成功","code":"00","data":{"list":[{"Field":"thedate","Type":"int","Null":"NO","Key":"","Default":null,"Extra":""},{"Field":"dtEventTime","Type":"varchar(32)","Null":"NO","Key":"","Default":null,"Extra":""},{"Field":"dtEventTimeStamp","Type":"bigint","Null":"NO","Key":"","Default":null,"Extra":""},{"Field":"RoomId","Type":"varchar(64)","Null":"YES","Key":"","Default":null,"Extra":""},{"Field":"Peakcpuutilpct","Type":"double","Null":"YES","Key":"","Default":null,"Extra":""}]},"errors":null,"trace_id":"00000000000000000000000000000000","span_id":"0000000000000000"}`,
