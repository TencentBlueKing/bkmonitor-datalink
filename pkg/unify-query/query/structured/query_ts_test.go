...
func TestQueryTs_ToQueryReference(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		"手动开启合并 doris 查询": {
			...
			isDirectQuery: false,
			promql:        `count(a)`,
			refString:     `{"a":[{"query_list":[{"storage_type":"bk_sql","storage_id":"0","data_source":"bklog","data_label":"multi_doris","table_id":"rt.doris_1","db":"100915_bklog_pub_svrlog_pangusvr_lobby_analysis","dbs":["100915_bklog_pub_svrlog_pangusvr_lobby_analysis","100915_bklog_pub_svrlog_pangusvr_other_9_analysis"],"measurement":"doris","field":"kube_pod_info","time_field":{},"fields":["kube_pod_info"],"measurements":["doris"],"metric_names":["bklog:rt:doris_1:kube_pod_info"],"vm_condition":"__name__=\"kube_pod_info_value\"","vm_condition_num":1,"offset_info":{"OffSet":0,"Limit":0,"SOffSet":0,"SLimit":0},"is_merge_db":true}],"reference_name":"a","metric_name":"kube_pod_info","is_count":false}]}`,
		},
		"默认不合并 doris 查询": {
			ts: &QueryTs{
				QueryList: []*Query{
