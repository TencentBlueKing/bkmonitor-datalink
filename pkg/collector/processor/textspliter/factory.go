...
func newFactory(conf map[string]interface{}, customized []processor.SubConfigProcessor) (*textSpliter, error) {
...
func (p *textSpliter) Reload(config map[string]interface{}, customized []processor.SubConfigProcessor) {
