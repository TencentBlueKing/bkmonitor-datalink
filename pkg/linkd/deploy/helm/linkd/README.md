...
Chart 版本为 `0.1.4`。Linkd 与 Console 的默认镜像分别为 `ghcr.io/tencentblueking/bkmonitor-datalink/linkd:0.1.4`
和 `ghcr.io/tencentblueking/bkmonitor-datalink/linkd-console:0.1.4`；可选模拟器使用独立的 `linkd-eventgen:0.1.1`。
