...
import (
	...
	bktencentcomv1alpha1 "github.com/TencentBlueKing/bkmonitor-datalink/pkg/bk-log-sidecar/api/bk.tencent.com/v1alpha1"
	...
	v1alpha1 "github.com/TencentBlueKing/bkmonitor-datalink/pkg/bk-log-sidecar/pkg/generated/listers/bk.tencent.com/v1alpha1"
...
func NewFilteredBkLogConfigInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&bktencentcomv1alpha1.BkLogConfig{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bkLogConfigInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bktencentcomv1alpha1.BkLogConfig{}, f.defaultInformer)
}
