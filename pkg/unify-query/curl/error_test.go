...
func TestHandleClientError(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			expectedContains: "查询超时: 请求 http://elasticsearch.example.com:9200/logs/_search 超时",
		...
		},
		{
			...
			expectedContains: "查询超时: 请求 http://doris.example.com:8030/api/query 超时",
			expectedStatus:   metadata.StorageTimeout,
		},
		{
			...
			expectedContains: "查询出错: 请求地址: http://influxdb.example.com:8086/query",
		...
		},
		{
			...
			expectedContains: "查询出错: 请求地址: http://bksql.example.com/api/v1/query",
			expectedStatus:   metadata.StorageError,
		},
	}
