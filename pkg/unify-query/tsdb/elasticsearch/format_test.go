...
func TestFormatFactory_RangeQueryAndAggregates(t *testing.T) {
	...
	for name, c := range map[string]struct {
		...
		"aggregate with collapse": {
			...
			expected: `{"aggregations":{"gseIndex":{"aggregations":{"_collapse":{"aggregations":{"time":{"aggregations":{"_value":{"value_count":{"field":"value"}}},"date_histogram":{"extended_bounds":{"max":1721046420,"min":1721024820},"field":"time","interval":"1m","min_doc_count":0,"time_zone":"Asia/ShangHai"}}},"terms":{"field":"hostname","missing":" ","size":1}}},"terms":{"field":"gseIndex","missing":" "}}},"query":{"range":{"time":{"format":"epoch_second","from":1721024820,"include_lower":true,"include_upper":true,"to":1721046420}}}}`,
		},
		"aggregate with dimension conflict": {
			timeField: metadata.TimeField{
				Name: "time",
				Type: TimeFieldTypeTime,
				Unit: function.Second,
			...
			aggregates: metadata.Aggregates{
				...
				{
					Name:       "count",
					Dimensions: []string{"gseIndex", "hostname"}, // contains collapse field
					Window:     time.Minute,
					TimeZone:   "Asia/ShangHai",
				},
			},
		...
		"aggregate with collapse at end": {
			timeField: metadata.TimeField{
				Name: "time",
				Type: TimeFieldTypeTime,
				Unit: function.Second,
		...
		"aggregate with multiple dimensions and collapse": {
			timeField: metadata.TimeField{
				Name: "time",
				Type: TimeFieldTypeTime,
				Unit: function.Second,
			...
			aggregates: metadata.Aggregates{
				...
				{
					Name:       "count",
					Dimensions: []string{"gseIndex", "region", "service"},
					Window:     time.Minute,
					TimeZone:   "Asia/ShangHai",
				},
			},
			expected: `{"aggregations":{"service":{"aggregations":{"region":{"aggregations":{"gseIndex":{"aggregations":{"_collapse":{"aggregations":{"time":{"aggregations":{"_value":{"value_count":{"field":"value"}}},"date_histogram":{"extended_bounds":{"max":1721046420,"min":1721024820},"field":"time","interval":"1m","min_doc_count":0,"time_zone":"Asia/ShangHai"}}},"terms":{"field":"hostname","missing":" ","size":1}}},"terms":{"field":"gseIndex","missing":" "}}},"terms":{"field":"region","missing":" "}}},"terms":{"field":"service","missing":" "}}},"query":{"range":{"time":{"format":"epoch_second","from":1721024820,"include_lower":true,"include_upper":true,"to":1721046420}}}}`,
		},
		"aggregate with different aggregate function and collapse": {
			timeField: metadata.TimeField{
				Name: "time",
				Type: TimeFieldTypeTime,
				Unit: function.Second,
			...
			expected: `{"aggregations":{"gseIndex":{"aggregations":{"_collapse":{"aggregations":{"time":{"aggregations":{"_value":{"max":{"field":"value"}}},"date_histogram":{"extended_bounds":{"max":1721046420,"min":1721024820},"field":"time","interval":"1m","min_doc_count":0,"time_zone":"Asia/ShangHai"}}},"terms":{"field":"hostname","missing":" ","size":1}}},"terms":{"field":"gseIndex","missing":" "}}},"query":{"range":{"time":{"format":"epoch_second","from":1721024820,"include_lower":true,"include_upper":true,"to":1721046420}}}}`,
		},
	} {
		t.Run(name, func(t *testing.T) {
			ctx := metadata.InitHashID(context.Background())
