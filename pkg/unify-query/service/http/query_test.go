...
func TestQueryReferenceWithEs(t *testing.T) {
	...
	mock.Es.Set(map[string]any{
		...
		`{"aggregations":{"_value":{"value_count":{"field":"__ext.container_name"}}},"query":{"bool":{"filter":[{"bool":{"must":[{"bool":{"must_not":{"exists":{"field":"__ext.io_kubernetes_pod"}}}},{"bool":{"must_not":{"exists":{"field":"__ext.container_name"}}}}]}},{"range":{"dtEventTimeStamp":{"format":"epoch_second","from":1741154079,"include_lower":true,"include_upper":true,"to":1741155879}}}]}},"size":0}`: `{"took":283,"timed_out":false,"_shards":{"total":2,"successful":2,"skipped":0,"failed":0},"hits":{"total":{"value":10000,"relation":"gte"},"max_score":null,"hits":[]},"aggregations":{"_value":{"value":182486}}}`,
