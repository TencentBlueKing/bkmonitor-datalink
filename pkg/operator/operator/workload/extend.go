...
func newGameStatefulObjects(ctx context.Context, sharedInformer tkexinformers.SharedInformerFactory) (*Objects, error) {
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			...
			if !ok {
				logger.Errorf("excepted type GameStatefulSet, got %T", obj)
				return
			}
			objs.Set(Object{
				ID: ObjectID{
		...
		UpdateFunc: func(_, newObj interface{}) {
			...
			if !ok {
				logger.Errorf("excepted type GameStatefulSet, got %T", newObj)
				return
			}
			objs.Set(Object{
				ID: ObjectID{
...
func newGameDeploymentObjects(ctx context.Context, sharedInformer tkexinformers.SharedInformerFactory) (*Objects, error) {
	...
	informer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc: func(obj interface{}) {
			...
			if !ok {
				logger.Errorf("excepted type GameDeployment, got %T", obj)
				return
			}
			objs.Set(Object{
				ID: ObjectID{
		...
		UpdateFunc: func(_, newObj interface{}) {
			...
			if !ok {
				logger.Errorf("excepted type GameDeployment, got %T", newObj)
				return
			}
			objs.Set(Object{
				ID: ObjectID{
