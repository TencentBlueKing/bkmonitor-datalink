...
func TestApplyStateChunksAtTheStoreCallBound(t *testing.T) {
	for _, total := range []int{8192, 8193, 65536, 65537} {
		t.Run(strconv.Itoa(total), func(t *testing.T) {
			...
			rejected, err := fixture.coordinator.applyState(context.Background(), execution.OperationNormal, fixture.contract, fixture.fence, mutations, nil)
...
func TestApplyStateStopsAtTheFirstFailedChunk(t *testing.T) {
	...
	t.Run("transport failure in chunk 2", func(t *testing.T) {
		...
		fixture := newChunkFixture(store, 8192)
		_, err := fixture.coordinator.applyState(context.Background(), execution.OperationNormal, fixture.contract, fixture.fence, mutations, nil)
...
func TestApplyStateStopsBetweenChunksOnCancellation(t *testing.T) {
	...
	fixture := newChunkFixture(store, 8192)
	_, err := fixture.coordinator.applyState(ctx, execution.OperationNormal, fixture.contract, fixture.fence, chunkMutations(2*8192), nil)
...
func TestAdmitStateChunksAndMeasuresEncodedBytes(t *testing.T) {
	...
	rejected, encodedBytes, err := fixture.coordinator.admitState(context.Background(), execution.OperationNormal, fixture.contract, mutations)
