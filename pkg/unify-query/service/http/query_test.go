...
func TestQueryTsWithDoris(t *testing.T) {
  ...
  "series" : [ {
    ...
    "stat" : { "avg" : [ 0, 4643.625520110957 ], "count" : [ 0, 721 ], "max" : [ 1744678890000, 27269 ], "min" : [ 1744666350000, 2869 ], "sum" : [ 0, 3348054 ] },
...
func TestQueryReferenceWithEs(t *testing.T) {
	...
	for i, c := range map[string]struct {
		...
		"test for nested and not nested": {
			...
			result:        `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["events.name"],"group_values":["exception"],"values":[[1748936649000,1]],"stat":{"count":[0,1],"sum":[0,1],"min":[1748936649000,1],"max":[1748936649000,1],"avg":[0,1]}}]`,
		},
		"test regex with null": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
		...
		"统计数量，毫秒查询": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079123,182355]],"stat":{"count":[0,1],"sum":[0,182355],"min":[1741154079123,182355],"max":[1741154079123,182355],"avg":[0,182355]}}]`,
		},
		"统计数量": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079000,182486]],"stat":{"count":[0,1],"sum":[0,182486],"min":[1741154079000,182486],"max":[1741154079000,182486],"avg":[0,182486]}}]`,
		},
		"根据维度 __ext.container_name 进行 sum 聚合，同时用值正向排序": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__ext.container_name"],"group_values":["unify-query"],"values":[[1741154079123,182355]],"stat":{"count":[0,1],"sum":[0,182355],"min":[1741154079123,182355],"max":[1741154079123,182355],"avg":[0,182355]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__ext.container_name"],"group_values":[""],"values":[[1741154079123,4325521]],"stat":{"count":[0,1],"sum":[0,4325521],"min":[1741154079123,4325521],"max":[1741154079123,4325521],"avg":[0,4325521]}}]`,
		},
		"根据维度 __ext.container_name 进行 count 聚合，同时用值倒序": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__ext.container_name"],"group_values":["unify-query"],"values":[[1741154079000,182486]],"stat":{"count":[0,1],"sum":[0,182486],"min":[1741154079000,182486],"max":[1741154079000,182486],"avg":[0,182486]}}]`,
		},
		...
		"a + b": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079000,364972]],"stat":{"count":[0,1],"sum":[0,364972],"min":[1741154079000,364972],"max":[1741154079000,364972],"avg":[0,364972]}}]`,
		},
		"__ext.io_kubernetes_pod 统计去重数量": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079000,4]],"stat":{"count":[0,1],"sum":[0,4],"min":[1741154079000,4],"max":[1741154079000,4],"avg":[0,4]}}]`,
		},
		"__ext.io_kubernetes_pod 统计数量": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
		...
		"测试聚合周期大于查询周期": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741276800000,2367]],"stat":{"count":[0,1],"sum":[0,2367],"min":[1741276800000,2367],"max":[1741276800000,2367],"avg":[0,2367]}}]`,
		},
		"测试 sql 时区聚合逻辑 Asia/Shanghai 1d": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1764086400000,356203]],"stat":{"count":[0,1],"sum":[0,356203],"min":[1764086400000,356203],"max":[1764086400000,356203],"avg":[0,356203]}}]`,
		},
		"测试 sql 时区聚合逻辑 UTC": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
...
func TestQueryTs(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"test query": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1677081600000,30],[1677081660000,21],[1677081720000,1],[1677081780000,7],[1677081840000,4],[1677081900000,2],[1677081960000,100],[1677082020000,94],[1677082080000,34]],"stat":{"count":[0,9],"sum":[0,293],"min":[1677081720000,1],"max":[1677081960000,100],"avg":[0,32.55555555555556]}}],"is_partial":false}`,
		},
		...
		"test query  __name__ with raw 多指标单表": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","status"],"group_values":["bkmonitor:system:cpu_summary:free","failed"],"values":[[1677082200000,68]],"stat":{"count":[0,1],"sum":[0,68],"min":[1677082200000,68],"max":[1677082200000,68],"avg":[0,68]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","status"],"group_values":["bkmonitor:system:cpu_summary:usage","failed"],"values":[[1677082200000,34]],"stat":{"count":[0,1],"sum":[0,34],"min":[1677082200000,34],"max":[1677082200000,34],"avg":[0,34]}}],"is_partial":false}`,
		},
		...
		"test query  __name__ with raw 多指标单表 exporter": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:exporter:free","buzzy"],"values":[[1677082200000,70]],"stat":{"count":[0,1],"sum":[0,70],"min":[1677082200000,70],"max":[1677082200000,70],"avg":[0,70]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:exporter:usage","buzzy"],"values":[[1677082200000,68]],"stat":{"count":[0,1],"sum":[0,68],"min":[1677082200000,68],"max":[1677082200000,68],"avg":[0,68]}}],"is_partial":false}`,
		},
		"test query  __name__ with raw 多指标单表 standard_v2_time_series": {
			query:  `{"query_list":[{"data_source":"","table_id":"bk.standard_v2_time_series","field_name":".*","is_regexp":true,"field_list":null,"reference_name":"a","dimensions":[],"limit":0,"timestamp":null,"start_or_end":0,"vector_offset":0,"offset":"","offset_forward":false,"slimit":0,"soffset":0,"conditions":{"field_list":[],"condition_list":[]},"keep_columns":["_time","a"]}],"metric_merge":"a","result_columns":null,"start_time":"1677081600","end_time":"1677085600","step":"10m"}`,
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:standard_v2_time_series:free","buzzy"],"values":[[1677082200000,32]],"stat":{"count":[0,1],"sum":[0,32],"min":[1677082200000,32],"max":[1677082200000,32],"avg":[0,32]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:standard_v2_time_series:usage","buzzy"],"values":[[1677082200000,68]],"stat":{"count":[0,1],"sum":[0,68],"min":[1677082200000,68],"max":[1677082200000,68],"avg":[0,68]}}],"is_partial":false}`,
		},
		"test regx with __name__ 单指标单表": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","container","namespace"],"group_values":["merltrics_rest_request_status_200_count","message-history","lolstage"],"values":[[1677082080000,68],[1677082140000,68],[1677082200000,68],[1677082260000,68],[1677082320000,68],[1677082380000,68]],"stat":{"count":[0,6],"sum":[0,408],"min":[1677082080000,68],"max":[1677082080000,68],"avg":[0,68]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","container","namespace"],"group_values":["merltrics_rest_request_status_500_count","message-history","lolstage"],"values":[[1677082080000,12],[1677082140000,12],[1677082200000,12],[1677082260000,12],[1677082320000,12],[1677082380000,12],[1677082440000,12],[1677082500000,12],[1677082560000,12],[1677082620000,12],[1677082680000,12]],"stat":{"count":[0,11],"sum":[0,132],"min":[1677082080000,12],"max":[1677082080000,12],"avg":[0,12]}}],"is_partial":false}`,
		},
	}
...
func TestQueryTsClusterMetrics(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"rangeCase": {
			...
			`,
			result: `{"is_partial":false,"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["bkm_cluster"],"group_values":["default"],"values":[[1700903220000,1498687],[1700903340000,1499039.5]],"stat":{"count":[0,2],"sum":[0,2997726.5],"min":[1700903220000,1498687],"max":[1700903340000,1499039.5],"avg":[0,1498863.25]}}]}`,
		},
		"instanceCase": {
			query: `
                {
