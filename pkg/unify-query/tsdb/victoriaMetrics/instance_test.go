...
func TestInstance_QueryLabelValues(t *testing.T) {
	testCases := map[string]struct {
		...
		"test_1": {
			name:     "pod",
			expected: `["access.data","detect","trigger"]`,
		},
	}
	...
	mock.Vm.Set(map[string]any{
		`label_values:17301804581730184058pod{__name__="container_cpu_usage_seconds_total_value", result_table_id="2_bcs_prom_computation_result_table_00000", container="unify-query"}`: `{"result":true,"message":"成功","code":"00","data":{"result_table_scan_range":null,"cluster":"monitor-1","totalRecords":3,"external_api_call_time_mills":{"bkbase_meta_api":1,"bkbase_storekit_api":0},"resource_use_summary":{"cpu_time_mills":0,"memory_bytes":0,"processed_bytes":0,"processed_rows":0},"source":"","list":[{"status":"success","isPartial":false,"data":["access.data","detect","trigger"]}],"stage_elapsed_time_mills":{"check_query_syntax":0,"query_db":24,"get_query_driver":0,"match_query_forbidden_config":0,"convert_query_statement":0,"connect_db":0,"match_query_routing_rule":0,"check_permission":1,"check_query_semantic":0,"pick_valid_storage":0},"select_fields_order":[],"sql":"{result_table_id=\"100147_user_custom_metric_result_table_1100011\", __name__=\"bkmonitor_process_overflow_total_value\"}","total_record_size":728,"timetaken":0.025,"result_schema":null,"bksql_call_elapsed_time":0,"device":"vm","result_table_ids":["100147_user_custom_metric_result_table_1100011"]},"errors":null,"trace_id":"73d949515c3627766de1e4eca917fac0","span_id":"2c52b38d7b8b7ee2"}`,
	})
