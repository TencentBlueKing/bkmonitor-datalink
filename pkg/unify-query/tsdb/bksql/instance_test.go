	...
	for _, c := range testCases {
		t.Run(c.name, func(t *testing.T) {
			...
			fieldsMap := metadata.FieldsMap{
				...
				"alias_field":                       {FieldType: sql_expr.DorisTypeText},
				"severity":                          {FieldType: sql_expr.DorisTypeText},
				"source_ip":                         {FieldType: sql_expr.DorisTypeText},
				"bk_host_id":                        {FieldType: sql_expr.DorisTypeText},
				"events":                            {FieldType: sql_expr.DorisTypeText},
				...
				"resource.bk.instance.id":           {FieldType: sql_expr.DorisTypeText},
