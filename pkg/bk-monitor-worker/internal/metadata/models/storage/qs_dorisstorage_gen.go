...
// nolint: dupl
func (qs DorisStorageQuerySet) OriginTableIdEq(originTableId string) DorisStorageQuerySet {
	return qs.w(qs.db.Where("origin_table_id = ?", originTableId))
}

// OriginTableIdIn is an autogenerated method
// nolint: dupl
func (qs DorisStorageQuerySet) OriginTableIdIn(originTableId ...string) DorisStorageQuerySet {
...
// nolint: dupl
func (qs DorisStorageQuerySet) OrderAscByOriginTableId() DorisStorageQuerySet {
...
// nolint: dupl
func (qs DorisStorageQuerySet) OrderDescByOriginTableId() DorisStorageQuerySet {
...
// nolint: dupl
func (u DorisStorageUpdater) SetOriginTableId(originTableId string) DorisStorageUpdater {
	u.fields[string(DorisStorageDBSchema.OriginTableId)] = originTableId
	return u
}
...
var DorisStorageDBSchema = struct {
	...
	OriginTableId      DorisStorageDBSchemaField
	...
	OriginTableId:      DorisStorageDBSchemaField("origin_table_id"),
