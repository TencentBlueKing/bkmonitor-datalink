...
func TestLoadConfigFromType(t *testing.T) {
	t.Run("Platform", func(t *testing.T) {
		config := SelectConfigFromType([]string{"../example/fixtures/platform.yml"}, define.ConfigTypePlatform)
	...
	t.Run("Privileged", func(t *testing.T) {
		config := SelectConfigFromType([]string{"../example/fixtures/privileged.yml"}, define.ConfigTypePrivileged)
		assert.NotNil(t, config)
