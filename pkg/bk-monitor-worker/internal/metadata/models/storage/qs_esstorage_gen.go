...
// BkTenantIDEq filters records by tenant ID.
// MANUAL: only this tenant filter is required; queryset codegen was intentionally not run.
// nolint: dupl
func (qs ESStorageQuerySet) BkTenantIDEq(bkTenantID string) ESStorageQuerySet {
