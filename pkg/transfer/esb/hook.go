...
const (
	ConfESBMultiTenantMode   = "esb.multi_tenant_mode"
	...
	ConfESBUserApiAddress    = "esb.user_apigw_address"
...
func initConfiguration(c define.Configuration) {
	c.SetDefault(ConfESBMultiTenantMode, false)
	...
	c.SetDefault(ConfESBUserApiAddress, "")
