...
func newLifecycleCollector(source lifecycle.Source) *lifecycleCollector {
	...
	return &lifecycleCollector{
		source:             source,
		ready:              descriptor("ready", "Whether the alarmd consumer lifecycle is ready.", nil),
		assignedClaims:     descriptor("assigned_claims", "Current claims in this alarmd assignment.", nil),
