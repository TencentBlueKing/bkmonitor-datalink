...
func run(ctx context.Context, args []string, stdout, stderr io.Writer) int {
	...
	finiteInput := flags.String("go-capture", "", "finite Go Kafka range JSON; archives raw records without source group commits")
	...
	if *finiteInput != "" {
		...
		return runFiniteCaptureFile(ctx, configuration, *finiteInput, stdout, stderr)
	}
	if *businessInput != "" {
