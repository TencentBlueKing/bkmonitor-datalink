...
// nolint: dupl
func (u ResultTableUpdater) SetLabels(labels any) ResultTableUpdater {
	u.fields[string(ResultTableDBSchema.Labels)] = labels
	return u
}
...
var ResultTableDBSchema = struct {
	...
	Labels         ResultTableDBSchemaField
	...
	Labels:         ResultTableDBSchemaField("labels"),
