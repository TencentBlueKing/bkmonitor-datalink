...
func TestQueryRawWithScroll_ESFlow(t *testing.T) {
	...
	initEsMockData := map[string]any{
		`{"query":{"bool":{"filter":{"range":{"dtEventTimeStamp":{"format":"epoch_second","from":1723594000,"include_lower":true,"include_upper":true,"to":1723595000}}}}},"size":4,"slice":{"id":0,"max":3},"sort":["_doc"]}`: `{"_scroll_id":"scroll_id_0","hits":{"total":{"value":1,"relation":"eq"},"hits":[{"_index":"result_table.es","_id":"1","_source":{"dtEventTimeStamp":"1723594001000","data":"es_test1"}}]}}`,
		`{"query":{"bool":{"filter":{"range":{"dtEventTimeStamp":{"format":"epoch_second","from":1723594000,"include_lower":true,"include_upper":true,"to":1723595000}}}}},"size":3,"slice":{"id":1,"max":3},"sort":["_doc"]}`: `{"_scroll_id":"scroll_id_1","hits":{"total":{"value":1,"relation":"eq"},"hits":[{"_index":"result_table.es","_id":"2","_source":{"dtEventTimeStamp":"1723594002000","data":"es_test2"}}]}}`,
		`{"query":{"bool":{"filter":{"range":{"dtEventTimeStamp":{"format":"epoch_second","from":1723594000,"include_lower":true,"include_upper":true,"to":1723595000}}}}},"size":3,"slice":{"id":2,"max":3},"sort":["_doc"]}`: `{"_scroll_id":"scroll_id_2","hits":{"total":{"value":1,"relation":"eq"},"hits":[{"_index":"result_table.es","_id":"3","_source":{"dtEventTimeStamp":"1723594003000","data":"es_test3"}}]}}`,
	}
...
func TestQueryRawWithScroll_DorisFlow(t *testing.T) {
	...
	initDorisMockData := map[string]any{
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 4":          `{"result":true,"code":"00","message":"","data":{"totalRecords":2,"total_record_size":2,"list":[{"dtEventTimeStamp":"1723594001000","data":"doris_test1"},{"dtEventTimeStamp":"1723594002000","data":"doris_test2"}]}}`,
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 3 OFFSET 4": `{"result":true,"code":"00","message":"","data":{"totalRecords":2,"total_record_size":2,"list":[{"dtEventTimeStamp":"1723594003000","data":"doris_test3"},{"dtEventTimeStamp":"1723594004000","data":"doris_test4"}]}}`,
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 3 OFFSET 7": `{"result":true,"code":"00","message":"","data":{"totalRecords":2,"total_record_size":2,"list":[{"dtEventTimeStamp":"1723594005000","data":"doris_test5"},{"dtEventTimeStamp":"1723594006000","data":"doris_test6"}]}}`,
	}

	inProgressDorisMockData := map[string]any{
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 4 OFFSET 12": `{"result":true,"code":"00","message":"","data":{"totalRecords":2,"total_record_size":2,"list":[{"dtEventTimeStamp":"1723594007000","data":"doris_test7"},{"dtEventTimeStamp":"1723594008000","data":"doris_test8"}]}}`,
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 3 OFFSET 13": `{"result":true,"code":"00","message":"","data":{"totalRecords":2,"total_record_size":2,"list":[{"dtEventTimeStamp":"1723594009000","data":"doris_test9"},{"dtEventTimeStamp":"1723594010000","data":"doris_test10"}]}}`,
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 3 OFFSET 16": `{"result":true,"code":"00","message":"","data":{"totalRecords":2,"total_record_size":2,"list":[{"dtEventTimeStamp":"1723594011000","data":"doris_test11"},{"dtEventTimeStamp":"1723594012000","data":"doris_test12"}]}}`,
	}

	thirdRoundDorisMockData := map[string]any{
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 4 OFFSET 24": `{"result":true,"code":"00","message":"","data":{"totalRecords":0,"total_record_size":0,"list":[]}}`,
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 3 OFFSET 22": `{"result":true,"code":"00","message":"","data":{"totalRecords":0,"total_record_size":0,"list":[]}}`,
		"SELECT *, `dtEventTimeStamp` AS `_timestamp_` FROM `doris_db` WHERE `dtEventTimeStamp` >= 1723594000000 AND `dtEventTimeStamp` < 1723595000000 AND `dtEventTime` >= '2024-08-14 08:06:40' AND `dtEventTime` <= '2024-08-14 08:23:21' AND `thedate` = '20240814' LIMIT 3 OFFSET 25": `{"result":true,"code":"00","message":"","data":{"totalRecords":0,"total_record_size":0,"list":[]}}`,
	}
