...
// nolint: dupl
func (qs TimeSeriesMetricQuerySet) BkTenantIdEq(bkTenantId string) TimeSeriesMetricQuerySet {
...
var TimeSeriesMetricDBSchema = struct {
	BkTenantId     TimeSeriesMetricDBSchemaField
	...
	BkTenantId:     TimeSeriesMetricDBSchemaField("bk_tenant_id"),
