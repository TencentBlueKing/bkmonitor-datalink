...
func TestQueryReferenceWithEs(t *testing.T) {
	...
	mock.BkSQL.Set(map[string]any{
		...
		"SELECT COUNT(`dtEventTimeStamp`) AS `_value_`, ((CAST((FLOOR(__shard_key__ / 1000) + 480) / 1440 AS INT) * 1440 - 480) * 60 * 1000) AS `_timestamp_` FROM `2_bklog_bkunify_query_doris`.doris WHERE `dtEventTimeStamp` >= 1764124929000 AND `dtEventTimeStamp` <= 1764128529000 AND `dtEventTime` >= '2025-11-26 10:42:09' AND `dtEventTime` <= '2025-11-26 11:42:10' AND `thedate` = '20251126' GROUP BY _timestamp_ ORDER BY `_timestamp_` ASC LIMIT 2000005": `{"result":true,"message":"成功","code":"00","data":{"result_table_scan_range":{"2_bklog_pure_v4_log_doris_for_unify_query":{"start":"2025112600","end":"2025112623"}},"cluster":"doris-test","totalRecords":1,"external_api_call_time_mills":{"bkbase_auth_api":57,"bkbase_meta_api":0,"bkbase_apigw_api":21},"resource_use_summary":{"cpu_time_mills":0,"memory_bytes":0,"processed_bytes":0,"processed_rows":0},"source":"","list":[{"_value_":356203,"_timestamp_":1764086400000}],"bk_biz_ids":[],"stage_elapsed_time_mills":{"check_query_syntax":1,"query_db":38,"get_query_driver":0,"match_query_forbidden_config":0,"convert_query_statement":1,"connect_db":48,"match_query_routing_rule":0,"check_permission":58,"check_query_semantic":0,"pick_valid_storage":1},"select_fields_order":["_value_","_timestamp_"]},"errors":null,"trace_id":"00000000000000000000000000000000","span_id":"0000000000000000"}`,
	})
	...
	for i, c := range map[string]struct {
		...
		"test for existed": {
			...
			result:        `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["level"],"group_values":["error"],"values":[[1755846720000,0],[1755866880000,0],[1755887040000,0],[1755907200000,0],[1755927360000,0],[1755947520000,0],[1755967680000,0],[1755987840000,0],[1756008000000,0],[1756028160000,0],[1756048320000,0],[1756068480000,1020],[1756088640000,2212],[1756108800000,2878],[1756128960000,2955],[1756149120000,2911],[1756169280000,2059],[1756189440000,2303]],"stat":{"count":[0,18],"sum":[0,16338],"min":[1755846720000,0],"max":[1756128960000,2955],"avg":[0,907.6666666666666],"last":[1756189440000,2303]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["level"],"group_values":["info"],"values":[[1755846720000,0],[1755866880000,0],[1755887040000,0],[1755907200000,0],[1755927360000,0],[1755947520000,0],[1755967680000,0],[1755987840000,0],[1756008000000,0],[1756028160000,0],[1756048320000,0],[1756068480000,601388],[1756088640000,1571574],[1756108800000,1587097],[1756128960000,1349673],[1756149120000,1344883],[1756169280000,1445814],[1756189440000,1379732]],"stat":{"count":[0,18],"sum":[0,9280161],"min":[1755846720000,0],"max":[1756108800000,1587097],"avg":[0,515564.5],"last":[1756189440000,1379732]}},{"name":"_result2","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["level"],"group_values":["warn"],"values":[[1755846720000,0],[1755866880000,0],[1755887040000,0],[1755907200000,0],[1755927360000,0],[1755947520000,0],[1755967680000,0],[1755987840000,0],[1756008000000,0],[1756028160000,0],[1756048320000,0],[1756068480000,99596],[1756088640000,241651],[1756108800000,243758],[1756128960000,230839],[1756149120000,229981],[1756169280000,232953],[1756189440000,226724]],"stat":{"count":[0,18],"sum":[0,1505502],"min":[1755846720000,0],"max":[1756108800000,243758],"avg":[0,83639],"last":[1756189440000,226724]}}]`,
		},
		"test for timezone window": {
		...
		"test for nested and not nested": {
			...
			result:        `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["events.name"],"group_values":["exception"],"values":[[1748936649000,1]],"stat":{"count":[0,1],"sum":[0,1],"min":[1748936649000,1],"max":[1748936649000,1],"avg":[0,1],"last":[1748936649000,1]}}]`,
		},
		"test regex with null": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
		...
		"统计数量，毫秒查询": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079123,182355]],"stat":{"count":[0,1],"sum":[0,182355],"min":[1741154079123,182355],"max":[1741154079123,182355],"avg":[0,182355],"last":[1741154079123,182355]}}]`,
		},
		"统计数量": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079000,182486]],"stat":{"count":[0,1],"sum":[0,182486],"min":[1741154079000,182486],"max":[1741154079000,182486],"avg":[0,182486],"last":[1741154079000,182486]}}]`,
		},
		"根据维度 __ext.container_name 进行 sum 聚合，同时用值正向排序": {
			...
			// 修复后按 _value 升序排序: 182355 -> 4325521
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__ext.container_name"],"group_values":["unify-query"],"values":[[1741154079123,182355]],"stat":{"count":[0,1],"sum":[0,182355],"min":[1741154079123,182355],"max":[1741154079123,182355],"avg":[0,182355],"last":[1741154079123,182355]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__ext.container_name"],"group_values":[""],"values":[[1741154079123,4325521]],"stat":{"count":[0,1],"sum":[0,4325521],"min":[1741154079123,4325521],"max":[1741154079123,4325521],"avg":[0,4325521],"last":[1741154079123,4325521]}}]`,
		},
		"根据维度 __ext.container_name 进行 count 聚合，同时用值倒序": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__ext.container_name"],"group_values":["unify-query"],"values":[[1741154079000,182486]],"stat":{"count":[0,1],"sum":[0,182486],"min":[1741154079000,182486],"max":[1741154079000,182486],"avg":[0,182486],"last":[1741154079000,182486]}}]`,
		},
		...
		"a + b": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079000,364972]],"stat":{"count":[0,1],"sum":[0,364972],"min":[1741154079000,364972],"max":[1741154079000,364972],"avg":[0,364972],"last":[1741154079000,364972]}}]`,
		},
		"__ext.io_kubernetes_pod 统计去重数量": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154079000,4]],"stat":{"count":[0,1],"sum":[0,4],"min":[1741154079000,4],"max":[1741154079000,4],"avg":[0,4],"last":[1741154079000,4]}}]`,
		},
		"__ext.io_kubernetes_pod 统计数量": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
		...
		"__ext.io_kubernetes_pod 统计数量，毫秒": {
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741154040000,3277],[1741154100000,4444],[1741154160000,4577],[1741154220000,4668],[1741154280000,5642],[1741154340000,4860],[1741154400000,35988],[1741154460000,7098],[1741154520000,5287],[1741154580000,5422],[1741154640000,4906],[1741154700000,4447],[1741154760000,4713],[1741154820000,4621],[1741154880000,4417],[1741154940000,5092],[1741155000000,4805],[1741155060000,5545],[1741155120000,4614],[1741155180000,5121],[1741155240000,4854],[1741155300000,5343],[1741155360000,4789],[1741155420000,4755],[1741155480000,5115],[1741155540000,4588],[1741155600000,6474],[1741155660000,5416],[1741155720000,5128],[1741155780000,5050],[1741155840000,1299]],"stat":{"count":[0,31],"sum":[0,182355],"min":[1741155840000,1299],"max":[1741154400000,35988],"avg":[0,5882.419354838709],"last":[1741155840000,1299]}}]`,
		},
		"测试聚合周期大于查询周期": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1741276800000,2367]],"stat":{"count":[0,1],"sum":[0,2367],"min":[1741276800000,2367],"max":[1741276800000,2367],"avg":[0,2367],"last":[1741276800000,2367]}}]`,
		},
		"测试 sql 时区聚合逻辑 Asia/Shanghai 1d": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
			...
			result: `[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1764086400000,356203]],"stat":{"count":[0,1],"sum":[0,356203],"min":[1764086400000,356203],"max":[1764086400000,356203],"avg":[0,356203],"last":[1764086400000,356203]}}]`,
		},
		"测试 sql 时区聚合逻辑 UTC": {
			queryTs: &structured.QueryTs{
				QueryList: []*structured.Query{
		...
		t.Run(fmt.Sprintf("%s", i), func(t *testing.T) {
			...
			actual, err := json.Marshal(data.Tables)
			assert.Nil(t, err)
			assert.JSONEq(t, c.result, string(actual))
		})
	}
}
...
func TestQueryTs(t *testing.T) {
	...
	mock.InfluxDB.Set(map[string]any{
		`SELECT mean("usage") AS _value, "time" AS _time FROM cpu_summary WHERE time > 1677081599999000000 and time < 1677085659999000000 AND (bk_biz_id='2') GROUP BY time(1m0s) LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
		...
		`SELECT "usage" AS _value, *::tag, "time" AS _time FROM cpu_summary WHERE time > 1677081359999000000 and time < 1677085659999000000 AND ((notice_way='weixin' and status='failed') and bk_biz_id='2') LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT count("usage") AS _value, "time" AS _time FROM cpu_summary WHERE time > 1677081599999000000 and time < 1677085659999000000 AND (bk_biz_id='2') GROUP BY "status", time(1m0s) LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT count("free") AS _value, "time" AS _time FROM cpu_summary WHERE time > 1677081599999000000 and time < 1677085659999000000 AND (bk_biz_id='2') GROUP BY "status", time(1m0s) LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "usage" AS _value, *::tag, "time" AS _time FROM cpu_summary WHERE time > 1677081300000000000 and time < 1677085600000000000 AND (bk_biz_id='2') LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "free" AS _value, *::tag, "time" AS _time FROM cpu_summary WHERE time > 1677081300000000000 and time < 1677085600000000000 AND (bk_biz_id='2') LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "value" AS _value, *::tag, "time" AS _time FROM merltrics_rest_request_status_200_count WHERE time > 1677081300000000000 and time < 1677085600000000000 LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "value" AS _value, *::tag, "time" AS _time FROM merltrics_rest_request_status_500_count WHERE time > 1677081300000000000 and time < 1677085600000000000 LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "metric_value" AS _value, *::tag, "time" AS _time FROM exporter WHERE time > 1677081300000000000 and time < 1677085600000000000 AND (metric_name =~ /.*/) LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "usage" AS _value, *::tag, "time" AS _time FROM standard_v2_time_series WHERE time > 1677081300000000000 and time < 1677085600000000000 LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
		...
		`SELECT "free" AS _value, *::tag, "time" AS _time FROM standard_v2_time_series WHERE time > 1677081300000000000 and time < 1677085600000000000 LIMIT 100000005 SLIMIT 100005`: &decoder.Response{
			Results: []decoder.Result{
				{
					Series: []*decoder.Row{
						{
	...
	testCases := map[string]struct {
		...
		"test query": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":[],"group_values":[],"values":[[1677081600000,30],[1677081660000,21],[1677081720000,1],[1677081780000,7],[1677081840000,4],[1677081900000,2],[1677081960000,100],[1677082020000,94],[1677082080000,34]],"stat":{"count":[0,9],"sum":[0,293],"min":[1677081720000,1],"max":[1677081960000,100],"avg":[0,32.55555555555556],"last":[1677082080000,34]}}],"is_partial":false}`,
		},
		"test lost sample in increase": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["job","notice_way","status"],"group_values":["SLI","weixin","failed"],"values":[[1677081660000,52.499649999999995],[1677081720000,38.49981666666667],[1677081780000,46.66666666666667],[1677081840000,40],[1677081900000,16.25],[1677081960000,137.5],[1677082020000,247.5],[1677082080000,285],[1677082140000,263.6679222222223],[1677082200000,160.00106666666667],[1677082260000,51.00056666666667]],"stat":{"count":[0,11],"sum":[0,1338.5856888888889],"min":[1677081900000,16.25],"max":[1677082080000,285],"avg":[0,121.68960808080807],"last":[1677082260000,51.00056666666667]}}],"is_partial":false}`,
		},
		"test query support fuzzy __name__ with count": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["status"],"group_values":["failed"],"values":[[1677081600000,30],[1677081660000,21],[1677081720000,1],[1677081780000,7],[1677081840000,4],[1677081900000,2],[1677081960000,100],[1677082020000,94],[1677082080000,34]],"stat":{"count":[0,9],"sum":[0,293],"min":[1677081720000,1],"max":[1677081960000,100],"avg":[0,32.55555555555556],"last":[1677082080000,34]}}],"is_partial":false}`,
		},
		"test query  __name__ with raw 多指标单表": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","status"],"group_values":["bkmonitor:system:cpu_summary:free","failed"],"values":[[1677082200000,68]],"stat":{"count":[0,1],"sum":[0,68],"min":[1677082200000,68],"max":[1677082200000,68],"avg":[0,68],"last":[1677082200000,68]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","status"],"group_values":["bkmonitor:system:cpu_summary:usage","failed"],"values":[[1677082200000,34]],"stat":{"count":[0,1],"sum":[0,34],"min":[1677082200000,34],"max":[1677082200000,34],"avg":[0,34],"last":[1677082200000,34]}}],"is_partial":false}`,
		},
		...
		"test query  __name__ with raw 多指标单表 exporter": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:exporter:free","buzzy"],"values":[[1677082200000,70]],"stat":{"count":[0,1],"sum":[0,70],"min":[1677082200000,70],"max":[1677082200000,70],"avg":[0,70],"last":[1677082200000,70]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:exporter:usage","buzzy"],"values":[[1677082200000,68]],"stat":{"count":[0,1],"sum":[0,68],"min":[1677082200000,68],"max":[1677082200000,68],"avg":[0,68],"last":[1677082200000,68]}}],"is_partial":false}`,
		},
		"test query  __name__ with raw 多指标单表 standard_v2_time_series": {
			query:  `{"query_list":[{"data_source":"","table_id":"bk.standard_v2_time_series","field_name":".*","is_regexp":true,"field_list":null,"reference_name":"a","dimensions":[],"limit":0,"timestamp":null,"start_or_end":0,"vector_offset":0,"offset":"","offset_forward":false,"slimit":0,"soffset":0,"conditions":{"field_list":[],"condition_list":[]},"keep_columns":["_time","a"]}],"metric_merge":"a","result_columns":null,"start_time":"1677081600","end_time":"1677085600","step":"10m"}`,
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:standard_v2_time_series:free","buzzy"],"values":[[1677082200000,32]],"stat":{"count":[0,1],"sum":[0,32],"min":[1677082200000,32],"max":[1677082200000,32],"avg":[0,32],"last":[1677082200000,32]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","name"],"group_values":["bkmonitor:bk:standard_v2_time_series:usage","buzzy"],"values":[[1677082200000,68]],"stat":{"count":[0,1],"sum":[0,68],"min":[1677082200000,68],"max":[1677082200000,68],"avg":[0,68],"last":[1677082200000,68]}}],"is_partial":false}`,
		},
		"test regx with __name__ 单指标单表": {
			...
			result: `{"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","container","namespace"],"group_values":["merltrics_rest_request_status_200_count","message-history","lolstage"],"values":[[1677082080000,68],[1677082140000,68],[1677082200000,68],[1677082260000,68],[1677082320000,68],[1677082380000,68]],"stat":{"count":[0,6],"sum":[0,408],"min":[1677082080000,68],"max":[1677082080000,68],"avg":[0,68],"last":[1677082380000,68]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["__name__","container","namespace"],"group_values":["merltrics_rest_request_status_500_count","message-history","lolstage"],"values":[[1677082080000,12],[1677082140000,12],[1677082200000,12],[1677082260000,12],[1677082320000,12],[1677082380000,12],[1677082440000,12],[1677082500000,12],[1677082560000,12],[1677082620000,12],[1677082680000,12]],"stat":{"count":[0,11],"sum":[0,132],"min":[1677082080000,12],"max":[1677082080000,12],"avg":[0,12],"last":[1677082680000,12]}}],"is_partial":false}`,
		},
	}
...
func TestQueryRawWithInstance(t *testing.T) {
	...
	tcs := map[string]struct {
		...
		"highlight with gseIndex 8019256": {
			...
			total:    16,
			expected: `[{"__data_label":"es","__doc_id":"3440427488472403621","__highlight":{"gseIndex":["<mark>8019256</mark>"]},"__index":"v2_2_bklog_bkunify_query_20250710_0","__result_table":"result_table.es","_time":"1752115579000","cloudId":0,"dtEventTimeStamp":"1752115579000","file":"victoriaMetrics/instance.go:397","gseIndex":8019256,"iterationIndex":15,"level":"info","report_time":"2025-07-10T02:46:19.443Z","time":"1752115579000","trace_id":"af754e7bbf629abaee3499638974dda9"}]`,
			options:  `{"result_table.es|3":{"from":0}}`,
		},
		"query string ": {
			queryTs: &structured.QueryTs{
		...
		"query raw by doris": {
			...
			expected: `[{"__data_label":"bksql","__index":"2_bklog_bkunify_query_doris","__result_table":"result_table.doris","__shard_key__":29218083010,"_endtime_":"2025-07-21 16:03:40","_starttime_":"2025-07-21 16:03:40","_timestamp_":1753085020000,"_value_":1753085020000,"bk_host_id":1234,"cloudid":0,"dteventtime":"2025-07-21 16:03:40","dteventtimestamp":1753085020000,"gseindex":44444,"iterationindex":8,"localtime":"2025-07-21 16:03:45","path":"/proz/logds/Player/gggggggggggg.log","thedate":20250721,"time":1753085020}]`,
		},
...
func TestQueryTs_ToQueryReference(t *testing.T) {
	...
	err := json.Unmarshal([]byte(jsonData), &qts)
	assert.Nil(t, err)

	queryReference, err := qts.ToQueryReference(ctx)
	assert.Nil(t, err)
...
func TestQueryTsClusterMetrics(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"rangeCase": {
			...
			`,
			result: `{"is_partial":false,"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["bkm_cluster"],"group_values":["default"],"values":[[1700903220000,1498687],[1700903340000,1499039.5]],"stat":{"count":[0,2],"sum":[0,2997726.5],"min":[1700903220000,1498687],"max":[1700903340000,1499039.5],"avg":[0,1498863.25],"last":[1700903340000,1499039.5]}}]}`,
		},
		"instanceCase": {
			query: `
                {
			...
			`,
			result: `{"is_partial":false,"series":[{"name":"_result0","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["bkm_cluster","database","engine","hostname","id","index_type","path","retention_policy","wal_path"],"group_values":["default","_internal","tsm1","influxdb-0","43","inmem","/var/lib/influxdb/data/_internal/monitor/43","monitor","/var/lib/influxdb/wal/_internal/monitor/43"],"values":[[1700903220000,1498687]],"stat":{"count":[0,1],"sum":[0,1498687],"min":[1700903220000,1498687],"max":[1700903220000,1498687],"avg":[0,1498687],"last":[1700903220000,1498687]}},{"name":"_result1","metric_name":"","columns":["_time","_value"],"types":["float","float"],"group_keys":["bkm_cluster","database","engine","hostname","id","index_type","path","retention_policy","wal_path"],"group_values":["default","_internal","tsm1","influxdb-0","44","inmem","/var/lib/influxdb/data/_internal/monitor/44","monitor","/var/lib/influxdb/wal/_internal/monitor/44"],"values":[[1700903340000,1499039.5]],"stat":{"count":[0,1],"sum":[0,1499039.5],"min":[1700903340000,1499039.5],"max":[1700903340000,1499039.5],"avg":[0,1499039.5],"last":[1700903340000,1499039.5]}}]}`,
		},
	}
	for name, c := range testCases {
		t.Run(name, func(t *testing.T) {
