...
func eventProperties() map[string]any {
	return map[string]any{
		...
		"related_alert_ids":    keywordProperty(),
		"event_id":             keywordProperty(),
		"fingerprint":          keywordProperty(),
		"title":                storedStringProperty(),
		"content":              storedStringProperty(),
		"evaluations": map[string]any{"type": "nested", "dynamic": "strict", "properties": map[string]any{
			"severity": keywordProperty(), "action": keywordProperty(), "action_reason": storedStringProperty(),
		}},
