...
//	etl.timeUnix = func() int64 { return 1670243190 }
//	ctx, cancel := pipelineContext()
//	processor, err := etl.NewMetricsReportProcessor(ctx, "metrics_reporter", false)
//	if err != nil {
//
//	}
//	processor.SetRedisStore(&mockRedisKVImpl{T: t})
//
