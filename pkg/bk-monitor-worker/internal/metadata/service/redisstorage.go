...
type RedisStorageSvc struct {
	*storage.RedisStorage
}

func NewRedisStorageSvc(obj *storage.RedisStorage) RedisStorageSvc {
	return RedisStorageSvc{
		RedisStorage: obj,
	}
}

// StorageCluster 返回集群对象
func (a RedisStorageSvc) StorageCluster() (*storage.ClusterInfo, error) {
...
// ConsulConfig 获取redis storage的consul配置信息
func (a RedisStorageSvc) ConsulConfig() (*StorageConsulConfig, error) {
	// 集群信息
...
// CreateTable 创建存储
func (a RedisStorageSvc) CreateTable(tableId string, isSyncDb bool, storageConfig map[string]interface{}) error {
	return nil
}
