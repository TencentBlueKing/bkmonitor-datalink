...
func validDecisionSinkConfig() DecisionSinkConfig {
	return DecisionSinkConfig{
		...
		InputTopic:          "alarm-engine-trigger-input-shadow",
		OutputTopic:         "alarm-engine-trigger-decision-shadow",
		AllowedOutputTopics: []string{"alarm-engine-trigger-decision-shadow"},
