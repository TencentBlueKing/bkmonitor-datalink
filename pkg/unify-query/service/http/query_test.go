...
func TestQueryRawWithInstance(t *testing.T) {
	...
	mock.Es.Set(map[string]any{
		...
		`{"_source":{"includes":["group","user.first","user.last"]},"from":0,"query":{"bool":{"filter":[{"nested":{"path":"user","query":{"match_phrase":{"user.first":{"query":"John"}}}}},{"range":{"dtEventTimeStamp":{"format":"epoch_second","from":1723594000,"include_lower":true,"include_upper":true,"to":1723595000}}},{"query_string":{"analyze_wildcard":true,"fields":["*","__*"],"lenient":true,"query":"group: fans"}}]}},"size":5}`:    `{"took":2,"timed_out":false,"_shards":{"total":1,"successful":1,"skipped":0,"failed":0},"hits":{"total":{"value":1,"relation":"eq"},"max_score":0.0,"hits":[{"_index":"bk_unify_query_demo_2","_type":"_doc","_id":"aS3KjpEBbwEm76LbcH1G","_score":0.0,"_source":{"group":"fans","user":[{"first":"John","last":"Smith"},{"first":"Alice","last":"White"}]}}]}}`,
		...
		`{"_source":{"includes":["tags","user.first","user.last"]},"from":0,"query":{"bool":{"filter":[{"nested":{"path":"user","query":{"match_phrase":{"user.first":{"query":"John"}}}}},{"range":{"dtEventTimeStamp":{"format":"epoch_second","from":1723594000,"include_lower":true,"include_upper":true,"to":1723595000}}},{"query_string":{"analyze_wildcard":true,"fields":["*","__*"],"lenient":true,"query":"tags: important"}}]}},"size":5}`: `{"took":2,"timed_out":false,"_shards":{"total":1,"successful":1,"skipped":0,"failed":0},"hits":{"total":{"value":1,"relation":"eq"},"max_score":0.0,"hits":[{"_index":"bk_unify_query_demo_2","_type":"_doc","_id":"cT5KjpEBbwEm76LbeH3I","_score":0.0,"_source":{"tags":["important","urgent","critical"],"user":[{"first":"John","last":"Smith"},{"first":"Alice","last":"White"}]}}]}}`,
	...
	tcs := map[string]struct {
		...
		"nested query + query string 测试 + highlight": {
			...
			total:    1,
			expected: `[{"__data_label":"es","__doc_id":"aS3KjpEBbwEm76LbcH1G","__highlight":{"group":["<mark>fans</mark>"],"user.first":["<mark>John</mark>"]},"__index":"bk_unify_query_demo_2","__result_table":"result_table.es","group":"fans","user":[{"first":"John","last":"Smith"},{"first":"Alice","last":"White"}]}]`,
		},
		...
		"array highlight test": {
			...
			total:    1,
			expected: `[{"__data_label":"es","__doc_id":"cT5KjpEBbwEm76LbeH3I","__highlight":{"tags":["<mark>important</mark>"],"user.first":["<mark>John</mark>"]},"__index":"bk_unify_query_demo_2","__result_table":"result_table.es","tags":["important","urgent","critical"],"user":[{"first":"John","last":"Smith"},{"first":"Alice","last":"White"}]}]`,
		},
	}
