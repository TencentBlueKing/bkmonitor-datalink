...
func TestCompositeSchemaProvider_Priority(t *testing.T) {
	...
	customRd := &cmdb.ResourceDefinition{
		Namespace: "",
...
func TestCompositeSchemaProvider_ListMerge(t *testing.T) {
	...
	customRd1 := &cmdb.ResourceDefinition{
		Namespace: "custom",
		Name:      "app_instance",
		Fields:    []cmdb.FieldDefinition{{Name: "app_id", Required: true}},
	}
	customRd2 := &cmdb.ResourceDefinition{
		Namespace: "custom",
		Name:      "git_commit",
		Fields:    []cmdb.FieldDefinition{{Name: "commit_sha", Required: true}},
	}
...
func TestCompositeSchemaProvider_RelationMerge(t *testing.T) {
	...
	customRel := &cmdb.RelationDefinition{
		Namespace:    "custom",
		Name:         "app_to_commit",
