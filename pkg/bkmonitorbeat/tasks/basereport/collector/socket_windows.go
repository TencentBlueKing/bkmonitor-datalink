...
func GetAllTcp4Socket(filter SocketFilter) (map[uint64]ElementInfo, error) {
	...
	//  TCP    127.0.0.1:51095       0.0.0.0:22       ESTABLISHED     10464
	//  TCP    127.0.0.1:51280       127.0.0.1:80        ESTABLISHED     1748
	//  TCP    127.0.0.1:51327       127.0.0.1:28812      ESTABLISHED     2964
	//  TCP    127.0.0.1:51440       127.0.0.1:8080      CLOSE_WAIT      4052
	//  TCP    127.0.0.1:51441       127.0.0.1:8080      CLOSE_WAIT      4052
	//  TCP    127.0.0.1:51442       127.0.0.1:8080      ESTABLISHED     4052
...
func GetAllUdp4Socket(filter SocketFilter) (map[uint64]ElementInfo, error) {
	...
	// outStr : UDP    127.0.0.1:137         *:*                                    4
	// UDP    127.0.0.1:138         *:*                                    4
	// UDP    127.0.0.1:1900        *:*                                    6492
	// UDP    127.0.0.1:5353        *:*                                    5864
