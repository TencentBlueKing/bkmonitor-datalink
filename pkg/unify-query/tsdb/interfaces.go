...
type Instance interface {
	QueryFieldMap(ctx context.Context, query *metadata.Query, start, end time.Time) (map[string]metadata.FieldOption, error)
...
func (d *DefaultInstance) QueryFieldMap(ctx context.Context, query *metadata.Query, start, end time.Time) (map[string]metadata.FieldOption, error) {
	return nil, nil
}
