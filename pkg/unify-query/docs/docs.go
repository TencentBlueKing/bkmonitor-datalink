...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/query/ts": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "未指定 response_contract 时返回 legacy PromData；named_outputs/v1 返回命名多输出",
                        "schema": {
                            "$ref": "#/definitions/http.QueryTsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "http.NamedOutputData": {
            "type": "object",
            "properties": {
                "invalid_points": {
                    "description": "InvalidPoints 是被过滤的 NaN/Inf 点数。",
                    "type": "integer"
                },
                "is_partial": {
                    "description": "IsPartial 表示本输出是否部分成功或失败。",
                    "type": "boolean"
                },
                "reference_name": {
                    "description": "ReferenceName 对应请求 output_list 中的 reference_name。",
                    "type": "string",
                    "example": "A"
                },
                "series": {
                    "description": "Tables 使用与旧 PromData.series 相同的序列结构。",
                    "type": "array",
                    "items": {
                ...
                "state": {
                    "description": "State 取值为 SUCCESS、SUCCESS_EMPTY、PARTIAL 或 ERROR。",
                    "enum": [
                        "SUCCESS",
                        "SUCCESS_EMPTY",
                        "PARTIAL",
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/http.OutputState"
                        }
                    ],
                    "example": "SUCCESS"
                },
                "status": {
                    "description": "Status 保留本输出的路由或查询状态。",
                    "allOf": [
                        {
                            "$ref": "#/definitions/metadata.Status"
                        }
        ...
        "http.QueryTsResponse": {
            "type": "object",
            "properties": {
                "contract_version": {
                    "description": "ContractVersion 仅在 named_outputs/v1 响应中返回。",
                    "type": "string",
                    "enum": [
                        "named_outputs/v1"
                    ],
                    "example": "named_outputs/v1"
                },
                "is_partial": {
                    "type": "boolean"
                },
                "outputs": {
                    "description": "Outputs 仅在 named_outputs/v1 响应中返回。",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.NamedOutputData"
                    }
                },
                "result_table_id": {
                    "type": "array",
                ...
                "series": {
                    "description": "Series 是未指定 response_contract 时的旧单输出结果。",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.TablesItem"
                    }
        ...
        "query.Record": {
            ...
            "properties": {
                ...
                "db": {
                    "description": "DB / Measurement 是该时间段的物理查询目标。ES 使用 index_set + __default__，Doris 使用 bkbase_table_id + doris。",
                    "type": "string"
                },
                "enable_time": {
                    "description": "EnableTime 是该路由开始生效的 Unix 秒级时间戳。",
                    "type": "integer"
                },
                "measurement": {
                    "type": "string"
                ...
                "source_type": {
                    "description": "SourceType 是 ES 查询入口选择依据；BKData ES 分段需要覆盖外层 RT 的 source_type。",
                    "type": "string"
                },
                "storage_id": {
                    "description": "StorageID 是该时间段命中的存储集群 ID，用于定位底层存储实例。",
                    "type": "string"
                },
                "storage_name": {
                    "description": "StorageName / ClusterName 表示存储集群名，Doris 查询 BKBase 时会透传为 properties.cluster_name。",
                    "type": "string"
                },
                "storage_type": {
                    "description": "StorageType 是该时间段应查询的存储类型；Doris 在查询侧统一表达为 bk_sql。",
                    "type": "string"
                }
            }
        },
        "query.TsDBV2": {
            ...
            "properties": {
                ...
                "field_alias": {
                    "$ref": "#/definitions/metadata.FieldAlias"
                },
                "filters": {
                    "type": "array",
                    "items": {
                ...
                "metric_name": {
                    "description": "补充检索的元信息",
                    "type": "string"
                },
                "need_add_time": {
                    "description": "NeedAddTime",
                    "type": "boolean"
                },
                "segmented_enable": {
                    "type": "boolean"
                ...
                "source_type": {
                    "description": "SourceType 数据来源",
                    "type": "string"
                },
                "storage_cluster_records": {
                    "description": "StorageClusterRecords",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/query.Record"
                    }
                },
                "storage_id": {
                    "description": "将存储信息合并在 TsDB 中",
                    "type": "string"
                },
                "storage_name": {
                    "type": "string"
                ...
                "time_field": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/metadata.TimeField"
                        }
                    ]
                },
                "vm_rt": {
        ...
        "structured.QueryOutput": {
            "type": "object",
            "properties": {
                "expression": {
                    "description": "Expression 输出表达式；非 legacy 输出仅允许 query reference identity 表达式。",
                    "type": "string",
                    "example": "A"
                },
                "reference_name": {
                    "description": "ReferenceName 输出引用名，在同一 output_list 中必须唯一。",
                    "type": "string",
                    "example": "A"
                }
            }
        ...
        "structured.QueryTs": {
            ...
            "properties": {
                ...
                "is_es_batch": {
                    "description": "IsESBatch 是否启用 query_raw 的 ES 批量查询",
                    "type": "boolean"
                },
                "is_merge_db": {
                ...
                "is_search_after": {
                    "description": "IsSearchAfter 是否启用 SearchAfter 查询。仅用于 /query/raw 原始查询：Elasticsearch 使用原生游标；Doris 优先使用 __unique_key__，缺少时尝试 dtEventTimeStamp、gseIndex、iterationIndex 组合游标，再缺少时降级为 offset 分页；不能与 scroll 同时使用。",
                    "type": "boolean"
                },
                "legacy_output_ref": {
                    "description": "LegacyOutputRef 指向与 MetricMerge 等价的输出，供旧服务兼容降级。",
                    "type": "string",
                    "example": "C"
                },
                "limit": {
                ...
                "output_list": {
                    "description": "OutputList 按请求顺序声明命名输出。",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/structured.QueryOutput"
                    }
                },
                "query_list": {
                ...
                "response_contract": {
                    "description": "ResponseContract 显式选择命名多输出响应契约；为空时保持旧单输出行为。",
                    "type": "string",
                    "enum": [
                        "named_outputs/v1"
                    ],
