...
func TestQueryReferenceWithHandler(t *testing.T) {
	...
	testCases := map[string]struct {
		...
		"graph issue": {
			body:     `{"space_uid":"bkcc__2","query_list":[{"data_source":"bklog","table_id":"bklog_index_set_2567","field_name":"serverIp","is_regexp":false,"function":[{"method":"count","dimensions":["serverIp"]}],"time_aggregation":{},"is_dom_sampled":false,"reference_name":"a","limit":20,"conditions":{"field_list":[{"field_name":"serverIp","value":[""],"op":"ne"}]},"query_string":"*","sql":"","is_prefix":false}],"metric_merge":"a","order_by":["-_value"],"start_time":"1766482431584","end_time":"1766568831585","step":"1h","timezone":"Asia/Shanghai","instant":false,"not_time_align":false}`,
			expected: `{}`,
		},
	}
