...
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalEq(flushInterval int64) KafkaTopicInfoQuerySet {
	return qs.w(qs.db.Where("flush_interval = ?", flushInterval))
}

// FlushIntervalGt is an autogenerated method
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalGt(flushInterval int64) KafkaTopicInfoQuerySet {
	return qs.w(qs.db.Where("flush_interval > ?", flushInterval))
}

// FlushIntervalGte is an autogenerated method
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalGte(flushInterval int64) KafkaTopicInfoQuerySet {
	return qs.w(qs.db.Where("flush_interval >= ?", flushInterval))
}

// FlushIntervalIn is an autogenerated method
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalIn(flushInterval ...int64) KafkaTopicInfoQuerySet {
...
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalLt(flushInterval int64) KafkaTopicInfoQuerySet {
	return qs.w(qs.db.Where("flush_interval < ?", flushInterval))
}

// FlushIntervalLte is an autogenerated method
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalLte(flushInterval int64) KafkaTopicInfoQuerySet {
	return qs.w(qs.db.Where("flush_interval <= ?", flushInterval))
}

// FlushIntervalNe is an autogenerated method
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalNe(flushInterval int64) KafkaTopicInfoQuerySet {
	return qs.w(qs.db.Where("flush_interval != ?", flushInterval))
}

// FlushIntervalNotIn is an autogenerated method
// nolint: dupl
func (qs KafkaTopicInfoQuerySet) FlushIntervalNotIn(flushInterval ...int64) KafkaTopicInfoQuerySet {
	if len(flushInterval) == 0 {
...
// nolint: dupl
func (u KafkaTopicInfoUpdater) SetFlushInterval(flushInterval int64) KafkaTopicInfoUpdater {
