...
func NewRecorder(build BuildInfo) *Recorder {
	...
	processDuration := prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Help:      "Alarm engine processing duration in seconds.",
	...
	processTotal := prometheus.NewCounterVec(
		prometheus.CounterOpts{
			...
			Subsystem: metricSubsystem,
			Name:      "process_total",
			Help:      "Alarm engine processing results.",
		},
	...
	recordsTotal := prometheus.NewCounterVec(
		prometheus.CounterOpts{
			...
			Subsystem: metricSubsystem,
			Name:      "records_total",
			Help:      "Alarm engine input and output records.",
		},
	...
	pipelineLatency := prometheus.NewHistogramVec(
		prometheus.HistogramOpts{
			...
			Help:      "Alarm engine latency between pipeline stages in seconds.",
	...
	shadowCompare := prometheus.NewCounterVec(
		prometheus.CounterOpts{
			...
			Help:      "Alarm engine shadow comparison results.",
		},
	...
	buildInfo := prometheus.NewGaugeVec(
		prometheus.GaugeOpts{
			...
			Subsystem: metricSubsystem,
			Name:      "build_info",
			Help:      "Alarm engine build information.",
		},
