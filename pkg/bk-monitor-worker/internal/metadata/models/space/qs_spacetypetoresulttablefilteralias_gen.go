...
// nolint: dupl
func (qs SpaceTypeToResultTableFilterAliasQuerySet) IsDeletedEq(isDeleted bool) SpaceTypeToResultTableFilterAliasQuerySet {
	return qs.w(qs.db.Where("is_deleted = ?", isDeleted))
}

// IsDeletedIn is an autogenerated method
// nolint: dupl
func (qs SpaceTypeToResultTableFilterAliasQuerySet) IsDeletedIn(isDeleted ...bool) SpaceTypeToResultTableFilterAliasQuerySet {
	if len(isDeleted) == 0 {
...
// nolint: dupl
func (qs SpaceTypeToResultTableFilterAliasQuerySet) IsDeletedNe(isDeleted bool) SpaceTypeToResultTableFilterAliasQuerySet {
	return qs.w(qs.db.Where("is_deleted != ?", isDeleted))
}

// IsDeletedNotIn is an autogenerated method
// nolint: dupl
func (qs SpaceTypeToResultTableFilterAliasQuerySet) IsDeletedNotIn(isDeleted ...bool) SpaceTypeToResultTableFilterAliasQuerySet {
	if len(isDeleted) == 0 {
...
// nolint: dupl
func (qs SpaceTypeToResultTableFilterAliasQuerySet) OrderAscByIsDeleted() SpaceTypeToResultTableFilterAliasQuerySet {
...
// nolint: dupl
func (qs SpaceTypeToResultTableFilterAliasQuerySet) OrderDescByIsDeleted() SpaceTypeToResultTableFilterAliasQuerySet {
...
// nolint: dupl
func (u SpaceTypeToResultTableFilterAliasUpdater) SetIsDeleted(isDeleted bool) SpaceTypeToResultTableFilterAliasUpdater {
	u.fields[string(SpaceTypeToResultTableFilterAliasDBSchema.IsDeleted)] = isDeleted
	return u
}
...
var SpaceTypeToResultTableFilterAliasDBSchema = struct {
	...
	IsDeleted   SpaceTypeToResultTableFilterAliasDBSchemaField
	...
	IsDeleted:   SpaceTypeToResultTableFilterAliasDBSchemaField("is_deleted"),
