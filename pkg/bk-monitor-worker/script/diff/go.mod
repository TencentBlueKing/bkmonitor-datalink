...
require (
	...
	github.com/TencentBlueKing/bkmonitor-datalink/pkg/utils v0.0.0-20240301092319-f348d765f0f7
...
replace github.com/TencentBlueKing/bkmonitor-datalink/pkg/bk-monitor-worker => ../../.
