...
func TestInstance_QueryRaw(t *testing.T) {
	...
	mock.BkSQL.Set(map[string]any{
		...
		"SHOW CREATE TABLE `5000140_bklog_container_log_demo_analysis`.doris": `{"result":true,"message":"成功","code":"00","data":{"list":[{"Field":"thedate","Type":"int","Null":"NO","Key":"YES","Default":null,"Extra":""},{"Field":"dteventtimestamp","Type":"bigint","Null":"NO","Key":"YES","Default":null,"Extra":""},{"Field":"dteventtime","Type":"varchar(32)","Null":"NO","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"localtime","Type":"varchar(32)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"__shard_key__","Type":"bigint","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"bk_host_id","Type":"bigint","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"path","Type":"text","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"log","Type":"text","Null":"YES","Key":"NO","Default":null,"Extra":"NONE","Analyzed":"true"},{"Field":"time","Type":"text","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"c1","Type":"text","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"c2","Type":"text","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"__ext","Type":"variant","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"gseindex","Type":"double","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"iterationindex","Type":"double","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"message","Type":"varchar(65533)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"report_time","Type":"varchar(65533)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"file","Type":"varchar(65533)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"trace_id","Type":"varchar(65533)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"cloudid","Type":"double","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"level","Type":"varchar(65533)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"},{"Field":"serverip","Type":"varchar(65533)","Null":"YES","Key":"NO","Default":null,"Extra":"NONE"}]}}`,
		...
		// query raw by doris long int
		"SELECT 2781777858072992322 AS iid FROM `2_bklog_pure_v4_log_doris_for_unify_query`.doris WHERE (`dtEventTimeStamp` >= 1730118589181 AND `dtEventTimeStamp` <= 1730118889181 AND `dtEventTime` >= '2024-10-28 20:29:49' AND `dtEventTime` <= '2024-10-28 20:34:50' AND `thedate` = '20241028') LIMIT 1": `{"result":true,"message":"成功","code":"00","data":{"result_table_scan_range":{"7_bklog_monitor_prod_analysis":{"start":"2025111900","end":"2025111923"}},"cluster":"doris_bklog","totalRecords":1,"external_api_call_time_mills":{"bkbase_auth_api":0,"bkbase_meta_api":0,"bkbase_apigw_api":0},"resource_use_summary":{"cpu_time_mills":0,"memory_bytes":0,"processed_bytes":0,"processed_rows":0},"source":"","list":[{"iid":2781777858072992322}],"bk_biz_ids":[],"stage_elapsed_time_mills":{"check_query_syntax":1,"query_db":23,"get_query_driver":0,"match_query_forbidden_config":0,"convert_query_statement":2,"connect_db":41,"match_query_routing_rule":0,"check_permission":1,"check_query_semantic":0,"pick_valid_storage":0},"select_fields_order":["iid"],"total_record_size":328,"trino_cluster_host":"","timetaken":0.068,"result_schema":[{"field_type":"long","field_name":"__c0","field_alias":"iid","field_index":0}],"bksql_call_elapsed_time":0,"device":"doris","result_table_ids":["7_bklog_monitor_prod_analysis"]},"errors":null,"trace_id":"00000000000000000000000000000000","span_id":"0000000000000000"}`,
	})
  ...
  "trace_id" : "adb84ecc380008245cdb800b6fd54d7f"
		...
		"query raw by doris long int": {
			query: &metadata.Query{
				...
				Field:       "dtEventTimeStamp",
				DataLabel:   "log_index_set_1183",
				SQL:         "SELECT (CAST 2781777858072992322 AS long) AS iid limit 1",
				Size:        5,
			},
			expected: `[{"__data_label":"log_index_set_1183","__index":"2_bklog_pure_v4_log_doris_for_unify_query","__result_table":"2_bklog.bklog_pure_v4_log_doris_for_unify_query","__table_uuid":"2_bklog.bklog_pure_v4_log_doris_for_unify_query","iid":2781777858072992322}]`,
		},
	} {
		t.Run(name, func(t *testing.T) {
			ctx = metadata.InitHashID(ctx)
...
func TestInstance_bkSql(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:  "query with regexp_extract and AS alias and null field",
			start: time.Unix(1755069858, 0),
			end:   time.Unix(1757661858, 0),
			query: &metadata.Query{
				DB:          "bklog_index_set_21692_analysis",
				...
				DataLabel:   "100915_bklog_pub_svrlog_pangusvr_lobby_analysis",
				QueryString: "buy weekly card success",
				SQL:         `SELECT DISTINCT (regexp_extract(log_1, 'openid:(\\d+)', 1)) AS id LIMIT 100000`,
			},
		...
		},
		{
			...
			expected: "SELECT NULL AS log_1 FROM `bklog_index_set_21692_analysis`.doris WHERE (`dtEventTimeStamp` >= 1755069858000 AND `dtEventTimeStamp` <= 1757661858000 AND `dtEventTime` >= '2025-08-13 15:24:18' AND `dtEventTime` <= '2025-09-12 15:24:19' AND `thedate` >= '20250813' AND `thedate` <= '20250912') LIMIT 100",
		},
		{
...
func TestInstance_QuerySeries(t *testing.T) {
	...
	mock.BkSQL.Set(map[string]any{
		...
		// 包含不存在字段的查询：SELECT DISTINCT path, NULL AS non_existent_field（dimTransform 将不存在的字段替换为 NULL）
		"SELECT DISTINCT `path`, NULL AS `non_existent_field` FROM `5000140_bklog_container_log_demo_analysis`.doris WHERE `dtEventTimeStamp` >= 1740551971000 AND `dtEventTimeStamp` <= 1740553771000 AND `dtEventTime` >= '2025-02-26 14:39:31' AND `dtEventTime` <= '2025-02-26 15:09:32' AND `thedate` = '20250226' LIMIT 10": `{"result":true,"message":"成功","code":"00","data":{"result_table_scan_range":{},"cluster":"doris-test","totalRecords":2,"external_api_call_time_mills":{},"resource_use_summary":{"cpu_time_mills":0,"memory_bytes":0,"processed_bytes":0,"processed_rows":0},"source":"","list":[{"path":"/var/log/test.log","non_existent_field":null},{"path":"/var/log/app.log","non_existent_field":null}],"select_fields_order":["path","non_existent_field"],"total_record_size":200,"timetaken":0.03,"result_schema":[],"bksql_call_elapsed_time":0,"device":"doris","result_table_ids":["5000140_bklog_container_log_demo_analysis"]},"errors":null,"trace_id":"","span_id":""}`,
	})
	...
	tests := []struct {
		...
		{
			name: "series query with non-existent field replaced by null",
			query: &metadata.Query{
				DB:          "5000140_bklog_container_log_demo_analysis",
				Measurement: "doris",
				Size:        10,
