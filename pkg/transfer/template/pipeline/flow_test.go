...
func (s *NetworkFlowPipelineSuite) SetupTest() {
	...
	s.ConsulConfig = `{"data_id":1603635,"etl_config":"bk_networkflow","result_table_list":[{"result_table":"flow_raw_test","schema_type":"free","shipper_list":[{"cluster_type":"elasticsearch","cluster_config":{"domain_name":"es.service.consul","port":9200},"storage_config":{"base_index":"flow_raw_test"}}],"field_list":[{"field_name":"dataid","type":"int","tag":"dimension","is_config_by_user":true},{"field_name":"sampler_address","type":"string","tag":"dimension","is_config_by_user":true},{"field_name":"src_addr","type":"string","tag":"dimension","is_config_by_user":true},{"field_name":"dst_addr","type":"string","tag":"dimension","is_config_by_user":true},{"field_name":"src_port","type":"int","tag":"dimension","is_config_by_user":true},{"field_name":"dst_port","type":"int","tag":"dimension","is_config_by_user":true},{"field_name":"proto","type":"string","tag":"dimension","is_config_by_user":true},{"field_name":"in_if","type":"int","tag":"dimension","is_config_by_user":true},{"field_name":"out_if","type":"int","tag":"dimension","is_config_by_user":true},{"field_name":"etype","type":"string","tag":"dimension","is_config_by_user":true},{"field_name":"type","type":"string","tag":"dimension","is_config_by_user":true},{"field_name":"time_flow_start_ns","type":"timestamp","tag":"metric","is_config_by_user":true},{"field_name":"time_flow_end_ns","type":"timestamp","tag":"metric","is_config_by_user":true},{"field_name":"time_received_ns","type":"timestamp","tag":"metric","is_config_by_user":true},{"field_name":"bytes","type":"int","tag":"metric","is_config_by_user":true},{"field_name":"packets","type":"int","tag":"metric","is_config_by_user":true},{"field_name":"sampling_rate","type":"int","tag":"metric","is_config_by_user":true},{"field_name":"stat_time","type":"timestamp","tag":"metric","is_config_by_user":true},{"field_name":"@timestamp","type":"timestamp","tag":"metric","is_config_by_user":true},{"field_name":"flow_bytes","type":"int","tag":"metric","is_config_by_user":true},{"field_name":"flow_packets","type":"int","tag":"metric","is_config_by_user":true}]}]}`
...
func (s *NetworkFlowPipelineSuite) TestFlowElasticsearchBackendPayload() {
	...
	pipe := s.BuildPipe(func(payload define.Payload) {
		...
		s.Equal(float64(1779421614), metrics["stat_time"])
		s.Equal(float64(1779421614), metrics["@timestamp"])
	})
