...
func TestOneModelClientFindRelatedHost(t *testing.T) {
	t.Parallel()
	var requests int
...
func TestOneModelClientFindRelatedHostRejectsAmbiguousEdge(t *testing.T) {
	t.Parallel()
...
func TestOneModelClientFindHostTopology(t *testing.T) {
	t.Parallel()
	transport := roundTripFunc(func(request *http.Request) (*http.Response, error) {
		data, _ := io.ReadAll(request.Body)
		body := string(data)
...
func TestOneModelClientFindHostTopologySelectsStablePath(t *testing.T) {
	t.Parallel()
...
func TestOneModelClientFindHostTopologyRejectsInvalidNodes(t *testing.T) {
	t.Parallel()
...
func TestOneModelClientFindHostTopologyRejectsInvalidMembership(t *testing.T) {
	t.Parallel()
	for _, test := range []struct {
		name        string
		memberships []map[string]any
