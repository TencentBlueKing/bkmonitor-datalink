...
func TestVmQueryParams(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			spaceUid: "vm-query",
			query:    `{"query_list":[{"field_name":"container_cpu_usage_seconds_total","function":[{"method":"sum","dimensions":["bcs_cluster_id","namespace"]}],"time_aggregation":{"function":"sum_over_time","window":"1m0s"},"reference_name":"a","conditions":{"field_list":[{"field_name":"bcs_cluster_id","value":["BCS-K8S-25428"],"op":"req"},{"field_name":"bcs_cluster_id","value":["BCS-K8S-25428"],"op":"req"},{"field_name":"bk_biz_id","value":["100801"],"op":"eq"}],"condition_list":["or", "and"]}},{"field_name":"container_cpu_usage_seconds_total","function":[{"method":"sum","dimensions":["bcs_cluster_id","namespace"]}],"time_aggregation":{"function":"count_over_time","window":"1m0s"},"reference_name":"b"}],"metric_merge":"a / b","start_time":"0","end_time":"600","step":"60s"}`,
			params:   `{"influx_compatible":true,"api_type":"query_range","api_params":{"query":"sum by (bcs_cluster_id, namespace) (sum_over_time(a[1m] offset -59s999ms)) / sum by (bcs_cluster_id, namespace) (count_over_time(b[1m] offset -59s999ms))","start":0,"end":600,"step":60},"result_table_group":{"a":["100147_bcs_prom_computation_result_table_25428"],"b":["100147_bcs_prom_computation_result_table_25428"]},"metric_filter_condition":{"a":"(bcs_cluster_id=~\"BCS-K8S-25428\" or (bcs_cluster_id=~\"BCS-K8S-25428\" and bk_biz_id=\"100801\")) and ((bcs_cluster_id=\"BCS-K8S-25428\" and namespace=\"bs-test\") or (bcs_cluster_id=\"BCS-K8S-25428\" and namespace=\"bs-main-0522\"))","b":"((bcs_cluster_id=\"BCS-K8S-25428\" and namespace=\"bs-test\") or (bcs_cluster_id=\"BCS-K8S-25428\" and namespace=\"bs-main-0522\"))"},"metric_alias_mapping":{"a":"container_cpu_usage_seconds_total_value","b":"container_cpu_usage_seconds_total_value"}}`,
		},
	}
