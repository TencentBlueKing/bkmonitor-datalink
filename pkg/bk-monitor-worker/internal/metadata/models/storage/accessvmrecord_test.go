...
func TestAccessVMRecord_RefreshVmRouter(t *testing.T) {
	...
	assert.True(t, ok)
	assert.True(t, record == `{"clusterName":"","db":"table_id_a","measurement":"base","retention_policies":{"autogen":{"is_default":true,"resolution":0}},"storageID":"1","table_id":"table_id_a.base","tagsKey":[],"vm_rt":"vm_test"}`)
}
